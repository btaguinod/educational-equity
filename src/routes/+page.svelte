...
<div class="container h-full mx-auto flex justify-center items-center">
	<div class="space-y-10 text-center flex flex-col items-center">
		<h2 class="h2">Welcome to the educational equity info site!</h2>
		<!-- Animated Logo -->
		<figure>
			...
			>
				<g>
					<g>
						...
						<path
							d="M58.4,10.1l-8-4C50.3,6,50.2,6,50,6h-8V3c0-1.7-1.3-3-3-3h-2c-0.8,0-1.5,0.3-2,0.7C34.5,0.2,33.8,0,33,0h-2
		...
		<div class="flex justify-center space-x-2">
			<a class="btn variant-filled" href="/theory-of-capital"> Learn now! </a>
		</div>
	</div>
</div>
